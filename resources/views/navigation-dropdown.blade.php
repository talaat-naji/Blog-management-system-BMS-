<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
  ...
  <h3 class="flex items-center">B.M.S</h3>
  </div>
         ...
         {{-- <a href='/feeds'> My Posts </a> --}}
          ...
          <div class="flex-shrink-2 flex items-center ml-4">
          <form action="/singlePost" method="POST">
               @csrf
                  <input type='hidden' value={{ Auth()->id()}} name="profId"/>
                  <input required type="text" name="search_input" placeholder="search posts by title ..."/>
                  <a><button ><b class='navbtn1'>Search</b></button></a>
             </form>
